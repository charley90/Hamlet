...
def bjsky(context, abc):
    ...
    q1 = query(indicator.code,valuation.pb_ratio,indicator.roe,indicator.roa,balance.total_current_liability,balance.total_current_assets,balance.inventories,cash_flow.net_operate_cash_flow,income.net_profit).filter(valuation.code.in_(pool))
    ...
    q2 = query(indicator.code,indicator.roe,indicator.roa).filter(indicator.code.in_(pool))
